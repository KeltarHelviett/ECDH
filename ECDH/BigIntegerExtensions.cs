...
namespace ECDH
{
	...
	{
		public static BigInteger Sqr(this BigInteger self) => self * self;
		...
		public static BigInteger ModInverse(this BigInteger a, BigInteger m, bool isDivisorPrime = false, bool isCoPrime = false)
		{
			a = a.EuclideanMod(m);
			if (isDivisorPrime)
		...
		public static BigInteger EuclideanMod(this BigInteger a, BigInteger m)
		{
			var r = a % m;
